"""
CreditSense AI — Scoring API
FastAPI service exposing /score endpoint for real-time credit risk scoring.

Run with: uvicorn api.scoring_api:app --reload --port 8000
"""
